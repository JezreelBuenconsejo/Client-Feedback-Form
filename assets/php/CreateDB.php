...
$sql6 = "CREATE TABLE `feedbackform`.`frontdeskOfficer` ( `frontdeskOfficerID` INT(5) UNSIGNED ZEROFILL NOT NULL AUTO_INCREMENT , `Name` VARCHAR(255) NOT NULL, PRIMARY KEY (`frontdeskOfficerID`)) ENGINE = InnoDB;";
...
$sql7 = "INSERT INTO `frontdeskOfficer` (`Name`) VALUES ('Jezreel Buenconsejo')";
if (mysqli_query($conn1, $sql7)) {
  echo 'Sucess adding Jezreel Buenconsejo <br>';
} else {
  echo "Error creating database: " . mysqli_error($conn1);
}

$sql8 = "INSERT INTO `frontdeskOfficer` (`Name`) VALUES ('Reven Maglaque')";
if (mysqli_query($conn1, $sql8)) {
  echo 'Sucess adding Reven Maglaque <br>';
} else {
  echo "Error creating database: " . mysqli_error($conn1);
}

$sql9 = "INSERT INTO `frontdeskOfficer` (`Name`) VALUES ('Jesfert Pabon')";
if (mysqli_query($conn1, $sql9)) {
  echo 'Sucess adding Jesfert Pabon <br>';
} else {
  echo "Error creating database: " . mysqli_error($conn1);
}
